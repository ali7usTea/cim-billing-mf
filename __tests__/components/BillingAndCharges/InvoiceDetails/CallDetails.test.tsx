...
import CallDetails from '../../../../src/app/main/components/BillingAndCharges/InvoiceDetails/CallDetails';

// Mock cim-ui-components
jest.mock('cim-ui-components', () => ({
  DataPanel: ({ queryParams, shouldRender, viewLayout }: any) =>
    shouldRender ? (
...
describe('CallDetails', () => {
  ...
  it('renders DataPanel when selectedInvoice is provided', () => {
    ...
    expect(screen.getByTestId('view-layout')).toHaveTextContent('table');
  });
